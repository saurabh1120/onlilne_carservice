...
<td>
  <input type="number" name="servicecharge" id="servicecharge" class="form-control wd-450" >
</td></tr>
<tr>
<th>Parts Charge: </th>
<td>
  <input type="number" name="partcharge" id="partcharge" class="form-control wd-450">
</td></tr>
<tr>
<th>Additional Charge: </th>
<td>
  <input type="number" name="addcharge" id="addcharge" class="form-control wd-450">
</td></tr>

                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Add ONGear Service Agent </h4>
    ...
    echo $msg;
                                                ...
                                                <form class="form-horizontal" role="form" method="post" name="submit">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Agent Name</label>
                                                        <div class="col-10">
                                                      ...
                                                      <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Agent Contact Number</label>
                                                        <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Agent Email</label>
                                                        <div class="col-10">
...
<div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Agent Address</label>
                                                        <div class="col-10">
